...
export default function ProductDetailClient({
  ...
  // CSR fetch for product details to trigger cookies natively and sync stock value.
        ...
        <div className="grid-2">
          ...
          <div className="product-detail">
            ...
            <div className="product-attribute-selector">
              ...
              >
                {[...Array(Math.max(1, Math.min(10, (selectedVariant ? selectedVariant.stock : product.stock) || 0)))].map((_, i) => (
